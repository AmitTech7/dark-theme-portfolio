export const portfolioData = {
  personal: {
    ...
    subtitle: "Accomplished React JS Developer with over 4+ years of experience creating intuitive user interfaces and integrating robust APIs",
    ...
    location: "Punjab, India (Sunny Enclave Kharar)",
  ...
  projects: [
    {
      ...
      description: "Comprehensive rental platform developed from scratch including POS and e-commerce apps. Built with Redux Thunk, Semantic UI, and atomic architecture. Features marketplace connecting customers and service providers, hardware integrations, and complete business management tools.",
      ...
      githubUrl: "https://github.com/AmitTech7/rental-platform",
      featured: true
    },
    {
      id: 2,
      title: "Lesson Plan Builder EdTech Platform",
      description: "Educational platform developed from scratch to simplify lesson preparation with intuitive interface. Features curated content library, grade-specific books, Kindle-like reading experience, and comprehensive lesson management tools for teachers.",
      image: "https://images.pexels.com/photos/5212345/pexels-photo-5212345.jpeg?auto=compress&cs=tinysrgb&w=600",
      tags: ["React.js", "Redux Thunk", "Semantic UI", "EdTech"],
      liveUrl: "https://github.com/AmitTech7/lesson-builder",
      githubUrl: "https://github.com/AmitTech7/lesson-builder",
      featured: true
    },
    {
      id: 3,
      title: "Insurance Claims Management System",
      description: "Complete revamp from ASP.NET to ASP.NET Core and React. Streamlines insurance claims facilitating interaction among motor body repairers, parts suppliers, and insurers. Built with Ant Design, RTK Query, and TypeScript with seamless legacy integration.",
      image: "https://images.pexels.com/photos/3183150/pexels-photo-3183150.jpeg?auto=compress&cs=tinysrgb&w=600",
      tags: ["React.js", "ASP.NET Core", "RTK Query", "TypeScript", "Ant Design"],
      liveUrl: "https://github.com/AmitTech7/claims-management",
      githubUrl: "https://github.com/AmitTech7/claims-management",
      featured: true
    },
    {
      id: 4,
      title: "Remote Patient Monitoring (Carehalo)",
      description: "HIPAA-compliant SAAS-based Virtual Patient Monitoring System for remote healthcare management. Supports web and mobile applications with EMR integrations, covering CCM, TCM, BHI, PCM, RTM, and RPM healthcare areas.",
      image: "https://images.pexels.com/photos/4386467/pexels-photo-4386467.jpeg?auto=compress&cs=tinysrgb&w=600",
      tags: ["React.js", "Healthcare", "HIPAA", "Mobile App", "EMR Integration"],
      liveUrl: "https://github.com/AmitTech7/carehalo",
      githubUrl: "https://github.com/AmitTech7/carehalo",
      featured: true
    },
    {
      id: 5,
      title: "WordPress Development Projects",
      description: "Various WordPress websites with custom themes, SEO optimization, and content management. Includes responsive designs, performance optimization, and client-specific customizations during freelancing period.",
      image: "https://images.pexels.com/photos/196644/pexels-photo-196644.jpeg?auto=compress&cs=tinysrgb&w=600",
      tags: ["WordPress", "SEO", "HTML", "CSS", "JavaScript"],
      liveUrl: "https://github.com/AmitTech7/wordpress-projects",
      githubUrl: "https://github.com/AmitTech7/wordpress-projects",
      featured: false
    }
  ],
  experience: [
    {
      ...
      description: "Currently working as a senior software associate leading React.js development projects. Responsible for architecting and developing complex web applications, mentoring junior developers, and ensuring high-quality code delivery.",
      achievements: [
    ...
    },
    {
      ...
      description: "Provided comprehensive web development services including WordPress development, SEO optimization, content writing, and custom web solutions using HTML, CSS, and JavaScript.",
      achievements: [
